...
export default function CaregiverDashboard() {
  ...
  return (
    <CaregiverLayout title="Dashboard Overview">
      <div className="p-8 space-y-6 bg-[#f6f7f8] min-h-full">
        <div className="flex justify-between items-end mb-6">
          <div>
            <h1 className="text-3xl font-bold text-[#0d141b]">Dashboard Overview</h1>
            <p className="text-[#4c739a] mt-1">Welcome back{user?.nombre ? `, ${user.nombre}` : ''}. Here's what's happening today.</p>
          </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <Card className="p-0 overflow-hidden">
                <div className="p-6 border-b border-[#e7edf3] flex justify-between items-center">
                  <h2 className="text-xl font-bold">Next Shift</h2>
                  <Link to="/caregiver/shifts" className="text-[#2b8cee] text-sm font-semibold hover:underline flex items-center">
                    View Calendar <span className="material-symbols-outlined text-sm ml-1">arrow_forward</span>
                  </Link>
                </div>
                {nextShift ? (
                  <div className="flex flex-col md:flex-row">
                    <div className="p-6 flex-1">
                      <div className="flex items-center gap-2 text-[#2b8cee] text-xs font-bold tracking-wider mb-2 uppercase">
                        ...
                        {nextShift.fecha === new Date().toISOString().split('T')[0] ? 'HAPPENING TODAY' : 'UPCOMING'}
                      </div>
                      ...
                      <div className="mb-6">
                        <p className="font-bold text-[#0d141b]">Patient: {nextShift.paciente?.nombre || 'Sin asignar'}</p>
                      </div>

                      <div className="flex gap-3">
                        <Button variant="primary">
                          Check In <span className="material-symbols-outlined ml-2 text-sm">login</span>
                        </Button>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-[#2b5cee] text-white rounded-xl p-6 shadow-sm">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="font-bold text-blue-100 uppercase tracking-wider text-sm">Hours Worked</h3>
                ...
                <div className="mb-6">
                  ...
                  <p className="text-xs text-blue-200 mt-2">You're on track to meet your monthly goal.</p>
                </div>
                <div className="grid grid-cols-1 gap-4 pt-4 border-t border-blue-400/30">
                  <div>
                    <p className="text-blue-200 text-xs uppercase tracking-wider mb-1">Earnings</p>
              ...
              <div className="grid grid-cols-1 gap-4">
                <Card className="text-center p-6">
                  ...
                  <p className="text-xs text-[#4c739a] uppercase tracking-wider mt-1">Active Patients</p>
                </Card>
              </div>
              ...
              <Card>
                <div className="flex justify-between items-center mb-6">
                  <h3 className="font-bold text-lg">Upcoming Week</h3>
                ...
                <div className="space-y-4">
                  {upcomingShifts.length > 0 ? upcomingShifts.map((shift, idx) => {
                    ...
                    <p className="text-sm text-[#4c739a]">No upcoming shifts this week.</p>
                  )}
                </div>
              </Card>
            </div>
